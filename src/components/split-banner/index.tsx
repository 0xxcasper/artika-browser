...
export default function SplitBanner({ sections, onCtaClick }: SplitBannerProps) {
  ...
  const handleImageMouseMove = (sectionId: string, event: React.MouseEvent<HTMLDivElement>) => {
      ...
      {sections.map((section) => (
        ...
        >
          ...
          <div className="desktop-layout">
            <div className={`content-wrapper ${section.textFirst ? 'text-first' : 'image-first'}`}>
              {/* Text Content */}
              <motion.div 
              ...
              >
                <motion.div 
                  ...
                  animate={{
                    x: hoveredImage === section.id ? mousePosition.x * PARALLAX_DISTANCE : 0,
                    y: hoveredImage === section.id ? mousePosition.y * PARALLAX_DISTANCE : 0,
                  }}
