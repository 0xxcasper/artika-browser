...
export class TourSubmissionService {
  ...
  static async submitTourRequest(data: {
    ...
    try {
      ...
      throw new Error(
        `Failed to submit tour request: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  ...
  static async getAllSubmissions(): Promise<TourSubmission[]> {
    try {
      ...
      throw new Error(
        `Failed to get tour submissions: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  ...
  static async markAsRead(submissionId: string): Promise<void> {
    try {
      ...
      throw new Error(
        `Failed to mark tour submission as read: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }

  // Update a submission with note
  static async updateSubmissionWithNote(
    submissionId: string,
    note: string,
  ): Promise<void> {
    try {
      ...
      throw new Error(
        `Failed to update tour submission with note: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  ...
  static async deleteSubmission(submissionId: string): Promise<void> {
    try {
      ...
      throw new Error(
        `Failed to delete tour submission: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  ...
  static async getUnreadCount(): Promise<number> {
    try {
      ...
      throw new Error(
        `Failed to get unread tour submissions count: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
}
...
export class NewsletterSubscriptionService {
  ...
  static async subscribeToNewsletter(data: {
    ...
    try {
      ...
      throw new Error(
        `Failed to submit newsletter subscription: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  ...
  static async getAllSubscriptions(): Promise<NewsletterSubscription[]> {
    try {
      ...
      const subscriptions = querySnapshot.docs.map((doc) => {
        ...
        return {
          ...
          unsubscribedAt: data.unsubscribedAt?.toDate
            ? data.unsubscribedAt.toDate()
            : data.unsubscribedAt
              ? new Date(data.unsubscribedAt)
              : undefined,
          note: data.note,
        };
      ...
      throw new Error(
        `Failed to get newsletter subscriptions: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }

  // Update subscription with note
  static async updateSubscriptionWithNote(
    ...
    try {
      ...
      throw new Error(
        `Failed to update newsletter subscription with note: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  ...
  static async deleteSubscription(subscriptionId: string): Promise<void> {
    try {
      ...
      throw new Error(
        `Failed to delete newsletter subscription: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
  ...
  static async getActiveCount(): Promise<number> {
    try {
      ...
      console.error(
        'Error getting active newsletter subscriptions count:',
        error,
      );
      throw new Error(
        `Failed to get active newsletter subscriptions count: ${error instanceof Error ? error.message : 'Unknown error'}`,
      );
    }
  }
}
